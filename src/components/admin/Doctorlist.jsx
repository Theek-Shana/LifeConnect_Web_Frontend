...
export default function DoctorList() {
  ...
  const fetchDoctors = async () => {
    try {
      ...
      const response = await fetch("http://localhost:5003/api/users?role=doctor", {
      ...
      <div style={styles.container}>
        <div style={styles.header}>
          <div>
            ...
            <p style={styles.subtitle}>{doctors.length} total doctors</p>
          </div>
        ...
        {doctors.length === 0 ? (
          ...
          <div style={styles.table}>
            ...
            {doctors.map((doctor) => (
              <div key={doctor._id} style={styles.tableRow}>
                ...
                <div style={styles.colEmail}>{doctor.email}</div>
                <div style={styles.colPhone}>{doctor.phone || "—"}</div>
                <div style={styles.colAddress}>{doctor.address || "—"}</div>
